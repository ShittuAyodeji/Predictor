      ...
      <ul class="nav navbar-nav navbar-right">
	   ...
	   <li class="signin-link"><a href="../how-to-play/">How To Play</a></li>
	      <?php
			...
			?>
			<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo ucfirst($_SESSION['firstname']); ?> <span class="caret"></span></a>
...
<!---<span id="timer"></span>-->
	...
	<h3 class="heading">How To Play</h3>
	</div>
