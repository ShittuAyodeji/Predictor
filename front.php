...
<html>
<head>
	<title>Predictor.ng | Predict 10 Matches and Win from our cash pool</title>
<script type="text/javascript" src="js/jquery-1.12.3.js"></script> 
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="fontawesome/css/font-awesome.min.css">
		<!--<link rel="stylesheet" href="fontawesome/web-fonts-with-css/css/fontawesome-all.css">--->
		<!--<link rel="stylesheet" type="text/css" href="flat-font/font/flaticon.css"> -->
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	?>
	<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo ucfirst($_SESSION['pid']); ?> <span class="caret"></span></a>
          <ul class="dropdown-menu">
			<li><a class="profile" href="#" data-toggle="modal" data-target="#myModal">Profile</a></li>
...
?>
	...
	<div class="col-sm-4 mobile-wrap general_results">
	<div class="view_results_wrap">
	<p  class="desktop headings">Results</p>
	 ...
	 <div class="col-sm-5 float-left fixtures">
	<p class="desktop headings">Fixtures</p>
	 <div class="view_predictions">
	 <p class="loading-fixtures"></p>
	 </div>
	 </div>
	 <div class="col-sm-3 mobile-wrap user-scores user_results">
	 <?php
 ...
 if(isset($_SESSION['pid'])){
		 ...
		 <div class="toggle-user-result">
			...
			<div class="row total-score" style="margin-bottom:10px;">
						...
						Total Score: <span class="badge view_user_score"></span>
						</div>
					</div>
	...
	<div class="predictions-template" style="display:none;">
	<?php include "template/board.php"; ?>
	</div>
	
	<div class="results-template" style="display:none;">
	<div class="row result-line">
		...
		<div class="col-sm-2 col-xs-1 col-md-2 float-left"><span class="badge">--score--</span></div>
	</div>
	</div>
	
	<div class="user-results-template" style="display:none;">
	...
	for(x in data){
						...
						for(let j=0; j<keysLen; j++){
							...
							if(data[x][object]=="no predictions"){
								template='<p class="alert alert-danger">You have not made any predictions today</p>';
							}
...
btn.addEventListener("click",function(e){
	...
	//document.querySelector(".predictions-wrap").classList.add("hide-board");
	e.preventDefault();
	}
});
